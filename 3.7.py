spisok = ['Аня', 'Пётр', 'Василий']  # Создаем переменную со списком гостей
spisok.insert(0, 'Наталья')  # С помощью метода insert добавляем Наташу в начало списка
spisok.insert(1, 'Ольга')  # С помощью метода insert добавляем Олю в середину списка
...
not_going0 = spisok.pop(0)  # Задаем переменную с методом pop() удаляя значение из контекста, но не из списка
...
message0 = 'Не приходи, ' + not_going0  # Cоздаем переменную с информацией, что гость не должен приходить
...
print(message0)  # Выводим эту информацию
